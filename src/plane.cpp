...
Plane Plane::getDefaultPlane(std::vector<std::tuple<glm::vec3, glm::vec3, glm::vec3>>& debugArrows, const Terrain& terrain) {
    ...
    Plane plane = Plane(
        glm::dvec3(20000, -1727, -20000), // pos
        ...
        Wheels(304670, 10, 60000, glm::dvec3(0, -3, -10), terrain), // Front wheels
    ...
    plane.orientation = glm::dquat(glm::dvec3(0,glm::radians(90.0+45.0),0));
