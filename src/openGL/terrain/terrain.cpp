...
void Terrain::geometry_pass(const glm::vec3& camera_pos,
...
void Terrain::load_textures() {
    heightmap = Texture("assets/terrain/hm.png", false, "terrain heightmap");
    splatmap = Texture("assets/terrain/alpha.png", false, "terrain splatmap");
    normalmap = Texture("assets/terrain/normal.png", false, "terrain normalmap");
