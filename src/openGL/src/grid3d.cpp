...
int frame = 0;
void Grid3d::render(const glm::vec3& cameraPos, const glm::mat4& view, const glm::mat4& projection) {
	...
	glm::mat4 model1 = glm::translate(glm::mat4(1.), 
	                    glm::vec3(  cameraPos.x, 
	                                int(cameraPos.y/Y_INCREMENT) * Y_INCREMENT, 
	                                cameraPos.z));
    ...
    glUniform3f(glGetUniformLocation(shader->getID(), "cameraPos"), cameraPos.x, cameraPos.y, cameraPos.z);
